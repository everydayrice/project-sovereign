...
export function intelligenceWorkbench(snapshot) {
 ...
 return `<nav class="section-nav" aria-label="Knowledge sections"><a href="#knowledge-review">Review (${pending.length})</a><a href="#knowledge-records">Saved knowledge</a><a href="#knowledge-search">Search</a><a href="#knowledge-history">History</a></nav>
